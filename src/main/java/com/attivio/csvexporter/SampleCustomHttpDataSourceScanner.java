...
/**
 *
 * This example demonstrate how to customize Http. For some configurations, the scanner uses a custom {@link HttpClientProviderFactory}
 * provider. For other configurations it uses the Attivio provided factory.
 */
...
public class SampleCustomHttpDataSourceScanner implements DataSourceScanner, HttpDataSourceScanner, BasicAuthentication {
  ...
  /**
   * If {@code contentUrl} is www.google.com then this scanner uses its own custom factory. Otherwise, uses the default factory.
   */
  @Override
  ...
  /**
   * This sample Http provider demonstrates a customized provider. In this case, the provider builds a very
   * simple {@link CloseableHttpClient} client without authentication and customizes of the connections TTL.
   *
   */
