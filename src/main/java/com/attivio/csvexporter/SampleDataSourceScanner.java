...
@ConfigurationOptionInfo(
    ...
    groups= {
        @ConfigurationOptionInfo.Group(path=ConfigurationOptionInfo.SCANNER ,propertyNames={"testText"})
    }
)
public class SampleDataSourceScanner implements DataSourceScanner {
  private String testText;
  
  @ConfigurationOption(longOpt = "set-test-text", displayName = "Test Text", description = "Text to be placed in the document")
