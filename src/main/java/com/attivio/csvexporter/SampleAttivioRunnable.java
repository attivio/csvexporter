...
public class SampleAttivioRunnable implements AttivioRunnable {
  ...
  @ConfigurationOption(optionLevel = OptionLevel.Required, shortOpt = "n", description = "The name of the project against which to search")
  ...
  @ConfigurationOption(shortOpt = "e", description = "The environment of the project against which to search")
  ...
  @ConfigurationOption(shortOpt = "z", description = "The connection string <host>:<port> to use to connect to zookeeper")
